...
class Link(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, font=controller.title_font , text="Instructions for Google Forms and Spreadsheets")
        label.pack(side="top", fill="x", padx=20, pady=50)

        label = tk.Label(self, font=controller.title_font, text="LINK")
        label.pack(side="top", fill="x", padx=20, pady=50)
